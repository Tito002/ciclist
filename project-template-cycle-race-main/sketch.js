...
mainCyclist.setColider("rectangle",0,0,mainCyclist.width,mainCyclist.height);
...
function draw() {
  ...
  text("FIM DE JOGO ;-; clique no botão seta para cima para reiniciar",300,240)
  textSize(15)
...
function reset(){
  gameState = PLAY
  gameOver.visible = false
  mainCyclist.addAnimation("SahilRunnig",mainRacerImg1);
